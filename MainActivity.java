...
TextView UserName,UserEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserEmail.setText(LoginActivity.USEREMAIL);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id)
        {
            case R.id.profile:
            {
                updateDisplay(new StudentProfile());
                break;
            }

            case R.id.news_event:
            {
                updateDisplay(new NewsFragment());
                break;
            }
            case R.id.directory:
            {
                updateDisplay(new DirectoryFragment());
                break;}

            case R.id.tnp:
             {
                 updateDisplay(new TnpFragment());
                  break;
            }

            case R.id.feedback:{
                updateDisplay(new FeedbackFragment());
                break;
            }
            case R.id.timetable:{
                break;
